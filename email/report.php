        ...
        * {
        ...
        @media (max-width: 480px) {
            #u_content_text_8 .v-container-padding-padding {
                padding: 10px 22px 70px !important;
            }
        }
    </style>
                                    ...
                                    <div style="width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                        ...
                                        <div style="padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                            ...
                                            <table id="u_content_text_8" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:70px 10px;font-family:arial,helvetica,sans-serif;" align="left">

                                                            <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span style="font-family: tahoma, arial, helvetica, sans-serif; font-size: 14px; line-height: 19.6px;"><strong><span style="font-size: 38px; line-height: 53.2px;">Message from your Site</span></strong></span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:50px 30px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            ...
                                                            <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%; text-align: left;"><span style="font-size: 18px; line-height: 25.2px;"><?php _e("Item Reported: ", 'direct'); ?></span><?php echo get_the_title($message['content']) ?></p>
                                                                <p style="font-size: 14px; line-height: 140%; text-align: left;"><span style="font-size: 18px; line-height: 25.2px;"><?php _e("Timestamp: ", 'direct'); ?></span><?php echo esc_html($message['timestamp']) ?></p>
                                                                <p style="font-size: 14px; line-height: 140%; text-align: left;"><span style="font-size: 18px; line-height: 25.2px;"><?php _e("Reported By: ", 'direct'); ?></span><?php echo esc_html($message['username']) ?></p>
                                                                <p style="font-size: 14px; line-height: 140%; text-align: left;"><span style="font-size: 18px; line-height: 25.2px;"><?php _e("Reason Given: ", 'direct'); ?></span><?php echo esc_html($message['reason']) ?></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:50px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            ...
                                                            <div style="color: #f8c567; line-height: 150%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 150%;"><span style="font-family: arial, helvetica, sans-serif; font-size: 20px; line-height: 30px;"><span style="line-height: 30px; font-size: 20px;"><?php echo esc_html($site_url) ?></span></span></p>
                                                            </div>
